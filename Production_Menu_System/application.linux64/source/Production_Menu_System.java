...
public class Production_Menu_System extends PApplet {
...
public void updateState(int changeDirection) {
...
public void playTransitionSounds(int changeType){
...
class MenuScreen { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "Production_Menu_System" };
    if (passedArgs != null) {
